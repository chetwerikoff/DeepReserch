...
class ResearchTests(unittest.TestCase):
    ...
    def test_candidate_discovery_contract_reuses_opportunistic_enrichment(self):
        ...
        self.assertEqual(worker_contract.count("at most **five tightly related derived search queries**"), 2)
        self.assertIn("at most five tightly related derived search queries", manager_contract)
